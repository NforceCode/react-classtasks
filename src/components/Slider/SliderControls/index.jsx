  ...
  render () {
    ...
    return (
      <div className={styles.controlsContainer}>
        <button className={cx(btnStyles)} onClick={this.toggleAutoSlide}>
          {isAutoSliderTurnedOn ? `Turn AutoSlider off` : `Turn AutoSlider on`}
        </button>
        <label>
          AutoSlider interval :{' '}
          <input
            ...
            type='number'
            placeholder='interval of autoslide'
            value={autoSliderSpeedS}
